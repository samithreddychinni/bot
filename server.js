...
// --- PATHS CONFIGURATION ---
// In a unified, flat structure, the project root is the current directory
const projectRoot = __dirname;
const frontendPath = projectRoot;
...
if (IS_RENDER_ENV) {
    ...
    console.warn("ChromaDB and WhatsApp session data will be ephemeral and lost on restart. Use UptimeRobot to keep the service alive.");
}
